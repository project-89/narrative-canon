/**
 * Camera Angle Text Builder (client-side copy)
 *
 * Maps three camera parameters (azimuth, elevation, distance)
 * to a single cinematography description string.
 * Client-side copy for real-time preview without server round-trip.
 */
