...
/**
 * Timeline Warfare - Extraction-Powered Edition (CommonJS)
 * 
 * Uses the narrative extraction system to create dynamic content
 */

const { NarrativePipeline } = require('./dist/pipeline.js');
const { GeminiAdapterImproved } = require('./dist/llm/gemini-improved.js');
const { MockLLMAdapter } = require('./dist/llm/mock.js');
